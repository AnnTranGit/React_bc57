...
export default class ProductForm extends Component {
    ...
    //cachs 1: can thiệp gán props vào state trước render của component 
    /*
    ...
    */
    ...
    //Cách 2 dùng componentWillMount can thiệp props đưa vào state trước render
    componentWillReceiveProps (newProps){
        //state thay đổi thì componentWillReceiveProps kg chạy
        this.setState({
        ...
        return (
            <form className='card' onSubmit={this.handleSubmit}>
                ...
                <div className='card-footer'>
                    ...
                    <button disabled={!this.state.isSubmit} className='btn btn-success mx-2' type='button' onClick={() => {
                        //Code chuc nang cap nhat du lieu arrayProduct
                        this.props.updateProducts(this.state.values)
                    }}> Update </button>
                </div>
            </form>
