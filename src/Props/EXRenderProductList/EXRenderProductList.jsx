...
export default class EXRenderProductList extends Component {
  render() {
    ...
    /**
     Props là gì?
      Là thuộc tính có sẵn của react class component dùng để nhận giá trị từ nơi sử dụng thẻ component này truyền vào (Component cha truyền vào )
     
     Props khác state?
     đều là thuộc tính có sẵn của component để chứa dữ liệu và binding trên giao diện

     + state có thể setState (Gán lại giá trị mới)
     + Props thì read-only giá trị không thể thay đổi
     * 
     */
